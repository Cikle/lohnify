class AppTranslations {
  static final Map<String, Map<String, String>> _translations = {
    'de': {
      ...
      'churchTax': 'Kirchensteuer (10%)',
      'marriageTaxDeduction': 'Steuerabzug für Verheiratete',
      'marriageTaxBenefitInfo': 'Steuerermässigung für Verheiratete: 2%',
      'yes': 'Ja',
      'no': 'Nein',
    ...
    'en': {
      'marriageTaxBenefitInfo': 'Tax reduction for married couples: 2%',
      'appTitle': 'Lohnify',
      'settings': 'Settings',
    ...
    'fr': {
      'marriageTaxBenefitInfo': 'Réduction dimpôt pour les couples mariés: 2 %',
      ...
      'married': 'Marié(e) (+2%)',
      'churchTax': 'Impôt ecclésiastique (10%)',
