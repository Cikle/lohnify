class AppTranslations {
  static final Map<String, Map<String, String>> _translations = {
    ...
    'en': {
      ...
      'calculatorHelpContent': 'Enter your gross salary and personal details to calculate your net salary. You can calculate for both employer and employee perspectives.',
      'taxesHelp': 'Taxes Information',
      'taxesHelpContent': 'Tax rates vary by canton. Church tax is optional and depends on your registration status.',
      'insuranceHelp': 'Insurance Information',
      'insuranceHelpContent': 'Social security contributions include AHV, IV, EO, and ALV. Additional insurance can be specified if applicable.',
      'savingHelp': 'Saving Calculations',
      'savingHelpContent': 'You can save your calculations for future reference or delete them when no longer needed.',
